        ...
        <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8">
          <div className="mt-16 grid grid-cols-1 gap-8 border-t border-gray-100 pt-16 md:grid-cols-4 lg:grid-cols-6">
            ...
            <div className="text-center sm:text-left md:col-span-4 lg:col-span-2">
              <p className="text-lg font-medium text-gray-900">Subscribe</p>

              <div className="mx-auto mt-8 max-w-md sm:ms-0">
                <p className="leading-relaxed text-gray-500 ltr:sm:text-left">
                ...
                <form className="mt-4">
                  <div className="flex flex-col gap-4 sm:flex-row lg:flex-col lg:items-start">
                    ...
                    <input
                      className="w-[250px] border rounded-md border-black px-4 py-1.5 shadow-sm"
                      type="email"
                      placeholder="Enter your email"
                    />

                    <button
                      className="block border border-black rounded-md px-4 py-1.5 font-medium text-black transition ml-2"
                      type="submit"
                    >
                      Subscribe
                    </button>
          ...
          <div className="mt-16 border-t border-black pt-6 sm:flex sm:items-center sm:justify-between">
