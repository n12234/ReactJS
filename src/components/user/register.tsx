              ...
              >
                <div className="col-span-6">
                  ...
                  <input
                    ...
                    id="username"
                    name="username"
                    className="mt-1 py-1.5 border w-full rounded-md border-gray-400 bg-white text-sm text-gray-700 shadow-sm"
                  />
                </div>
                ...
                <div className="col-span-6 text-red-500">{message}</div>
